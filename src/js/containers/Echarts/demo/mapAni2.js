...
export default class GDMap extends Component {
    ...
    componentDidMount() {
        console.log("gd_map");
        let map = new AMap.Map('container_id', {mapStyle: 'amap://styles/darkblue'});
        ...
        AMapUI.load([
            'ui/misc/PathSimplifier', 'ui/misc/PointSimplifier', 'lib/$'
        ], function (PathSimplifier, PointSimplifier, $) {

            let pointSimplifierIns2 = new PointSimplifier({
                zIndex: 115, autoSetFitView: false, map: map, //所属的地图实例
